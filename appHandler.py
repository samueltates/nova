...
app = cors(app, allow_origin=[os.environ.get("CORS_ALLOWED_ORIGINS")], allow_headers=["Content-Type", "Authorization"], expose_headers=["Content-Type", "Authorization"], max_age=86400, allow_methods=["GET", "POST", "PUT", "DELETE", "OPTIONS"])
