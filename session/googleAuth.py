...
from session.sessionHandler import novaSession, current_config, current_loadout, available_convos, active_cartridges, novaConvo, chatlog, agentName
from session.user import GoogleSignOn
    ...
    if creds_obj:
        ...
        if revoke_token(access_token):
            ...
            if sessionID in active_cartridges:
                active_cartridges.pop(sessionID)
