        ...
        for line in transcript_lines:
            ...
            for line in lines_split_by_word_count:
                if line != '':
                    ...
                    text_clip = TextClip(text.upper(), size = size, fontsize=font_size, color='white', kerning = kerning, method='caption', align='west', font = 'Oswald', stroke_color='black', stroke_width=stroke_width, interline=interline)
